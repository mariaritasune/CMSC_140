...
// Constants for max and min # of floors and rooms
...
int main() {
    ...
    // Ask for location and number of floors
    ...
    for (int floor = 1; floor <= numFloors; ++floor) {
        ...
        // Ask for number of rooms on this floor
        do {
        ...
        // Ask for number of occupied rooms for each room type
        ...
        // Check for minimum number of rooms
